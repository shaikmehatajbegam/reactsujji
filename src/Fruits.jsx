...
function Fruits() {
    ...
    const totalPages = Math.ceil(fruitItems.length / perPage); // Total pages
    ...
    const currentItems = fruitItems.slice(pageStartItemIndex, pageEndItemIndex);
    ...
    return (
        <div className="container mt-4">
            <h2 className="text-center text-danger">Welcome To Fruits Section 🍎</h2>
            <div className="row">
